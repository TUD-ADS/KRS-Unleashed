...
int main(int argc, char **argv)
{
    ...
    // Create a kernel:
    OCL_CHECK(err, cl::Kernel kernel(program, "cvtcolor_rgb2gray", &err));

    // Allocate the buffers:
    OCL_CHECK(err, cl::Buffer imageToDevice(context, CL_MEM_READ_ONLY, (height * width * decimate::INPUT_CH_TYPE), NULL,
                                            &err)); //,in_img.data);
    OCL_CHECK(err, cl::Buffer imageFromDevice(context, CL_MEM_WRITE_ONLY, (height * width * decimate::OUTPUT_CH_TYPE), NULL,
