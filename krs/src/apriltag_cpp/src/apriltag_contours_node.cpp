...
namespace apriltag_cpp
{
    ...
    class ApriltagContoursNode : public rclcpp::Node
    {
    public:
        ApriltagContoursNode()
            : Node("apriltag_contours_node"), family("Tag36h11"), params(), detector(family, params)
        {
            subscription_ = this->create_subscription<sensor_msgs::msg::Image>(
                "/apriltag/thresholded", 2, std::bind(&ApriltagContoursNode::topic_callback, this, std::placeholders::_1));
...
int main(int argc, char *argv[])
{
    ...
    rclcpp::spin(std::make_shared<apriltag_cpp::ApriltagContoursNode>());
    rclcpp::shutdown();
    return 0;
}
