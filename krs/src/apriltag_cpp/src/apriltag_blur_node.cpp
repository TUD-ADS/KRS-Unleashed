...
namespace apriltag_cpp
{
    ...
    class ApriltagBlurNode : public rclcpp::Node
    {
    public:
        ApriltagBlurNode()
            : Node("apriltag_blur_node"), family("Tag36h11"), params(), detector(family, params)
        {
            subscription_ = this->create_subscription<sensor_msgs::msg::Image>(
                "/apriltag/decimated", 2, std::bind(&ApriltagBlurNode::topic_callback, this, std::placeholders::_1));
...
int main(int argc, char *argv[])
{
    ...
    rclcpp::spin(std::make_shared<apriltag_cpp::ApriltagBlurNode>());
    rclcpp::shutdown();
    return 0;
}