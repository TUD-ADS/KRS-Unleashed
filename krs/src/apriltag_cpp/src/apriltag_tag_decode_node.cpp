...
namespace apriltag_cpp
{
    ...
    class ApriltagTagDecodeNode : public rclcpp::Node
    {
    public:
        ApriltagTagDecodeNode()
            : Node("apriltag_tag_decode_node"), family("Tag36h11"), params(), detector(family, params)
        {
            ...
            sync_->registerCallback(std::bind(&ApriltagTagDecodeNode::combined_callback,
...
int main(int argc, char *argv[])
{
    ...
    rclcpp::spin(std::make_shared<apriltag_cpp::ApriltagTagDecodeNode>());
    rclcpp::shutdown();
    return 0;
}