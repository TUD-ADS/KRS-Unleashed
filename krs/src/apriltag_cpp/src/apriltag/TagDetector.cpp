...
static const int kDefaultAdaptiveThresholdRadius = 7; // TODO: 9 not possible in Vitis
                              ...
                              QuadArray &quads) const
{
  ...
  {
    cv::GaussianBlur(images.origBW8, images.origBW8, cv::Size(0, 0), params.segSigma);
  }
  cv::Mat thresh;
