               ...
               at::real max_grad)
{
  ...
  for (iter = 0; iter < max_iter && !done; ++iter)
  {
    ...
    if (gn < max_grad || iter + 1 == max_iter)
    {
      done = true;
    }
    ...
    if (debug)
    {
      ...
      cv::imwrite("refine.png", debug_big);
    }
  }
