...
GLineSegment2D::GLineSegment2D(const at::Point &pp1, const at::Point &pp2) : p1(pp1), p2(pp2) {}
...
Quad::Quad(const at::Point pp[4], const at::Point &oc, at::real op) : opticalCenter(oc), observedPerimeter(op)
{
